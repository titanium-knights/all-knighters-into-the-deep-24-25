...
public class LConstants {
    static {
        ...
        ThreeWheelIMUConstants.turnTicksToInches = 0.0014035813648817649;//0.00345396830067402; //0.001998322827427511

        ThreeWheelIMUConstants.leftY = 14.2875;
        ThreeWheelIMUConstants.rightY = -14.9225;
