...
public class LeftOneSpecimenParkConfig implements IAutonConfig {
    ...
    public static final Pose START_POSE = new Pose(9, 82, Math.toRadians(0));
    ...
    public static final Pose SCORE_BUCKET_POSE = new Pose(16, 129, Math.toRadians(125));
    public static final Pose GET_OUT_OF_SCORE_BUCKET_POSE = new Pose(17, 128, Math.toRadians(125));

    // Parking Pose
    public static final Pose PARK_POSE1 = new Pose(60, 110, Math.toRadians(0));
    public static final Pose PARK_POSE2 = new Pose(70, 94, Math.toRadians(270));
