...
//
//    private final Pose scorePreloadedSpecimenPose = new Pose(36, 74, Math.toRadians(0));
//
...
//                .addPath(new BezierLine(new Point(startPose), new Point(parkAfterScoringSpecimenPose)))
//                .setLinearHeadingInterpolation(startPose.getHeading(), parkAfterScoringSpecimenPose.getHeading())
//                .build();
//    }
//
