...
public class SlidesBottomClawClosed extends AutonState {

    public SlidesBottomClawClosed(SubsystemManager subsystemManager) {
    ...
    public boolean update() {
        ...
        if (subsystemManager.slides.getSlidesState() == SlideState.BOTTOM && subsystemManager.topClaw.isClosed()) {
            return true;
        } else {
            return false;
        }
