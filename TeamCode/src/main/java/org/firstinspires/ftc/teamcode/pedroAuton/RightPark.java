...
@Autonomous(name = "DYING", group = "Pedro Autons")
public class RightPark extends OpMode {
    ...
    private final Pose moveToPrepToScorePreloadedSpecimenPose = new Pose(35, 62, Math.toRadians(0));

    private final Pose scorePreloadedSpecimenPose = new Pose(41.1, 62, Math.toRadians(0));

    private final Pose alignToPrepareForRetrieval1 = new Pose(20, 36, Math.toRadians(0));

    private final Pose retrieveSpecimenPose1_1 = new Pose(60, 32, Math.toRadians(0));

    private final Pose retrieveSpecimenPose1_2 = new Pose(60, 27, Math.toRadians(0));

    private final Pose retrieveSpecimenPose1_3 = new Pose(20, 27, Math.toRadians(0));

    private final Pose alignToPrepareForRetrieval2 = new Pose(20, 27, Math.toRadians(0));
    ...
    private final Pose retrieveSpecimenPose2_3 = new Pose(20, 20, Math.toRadians(0));

    private final Pose alignToPrepareForRetrieval3 = new Pose(20, 20, Math.toRadians(0));

    private final Pose retrieveSpecimenPose3_1 = new Pose(60, 20, Math.toRadians(0));

    private final Pose retrieveSpecimenPose3_2 = new Pose(60, 9.2, Math.toRadians(0));

    private final Pose retrieveSpecimenPose3_3 = new Pose(20, 9.2, Math.toRadians(0));
