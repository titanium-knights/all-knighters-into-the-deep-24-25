...
public class RightSpecimen extends OpMode {
    ...
    private final Pose prepareToLoadSpecimenPose = new Pose(10, 8, Math.toRadians(180));

    private final Pose pickupSpecimenPose = new Pose(8, 8, Math.toRadians(180));

    private final Pose goToScoringPositionAfterPickupPose = new Pose(36, 64, Math.toRadians(0));
    ...
    private PathChain scorePreloadedSpecimen, 
                      ...
                      prepareToLoadSpecimen, 
                      pickupSpecimen, 
                      goToScoringPositionAfterPickup,
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 80:
                if (!follower.isBusy()) {
                    follower.followPath(prepareToLoadSpecimen, true);
