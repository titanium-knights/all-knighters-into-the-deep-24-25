...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        ...
        // double check these
        par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, CONFIG.BACK_LEFT)));
        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, CONFIG.BACK_RIGHT)));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, CONFIG.FRONT_RIGHT)));
