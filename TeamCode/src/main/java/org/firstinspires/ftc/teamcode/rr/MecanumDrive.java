...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 1870.791667;
        public double lateralInPerTick = 1271.8322644109185;
        public double trackWidthTicks = 21720.94872160167;

        // feedforward parameters (in tick units)
        public double kS = 1.3733695264032018;
        public double kV = 0.00007380027385437645;
        public double kA = 0;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, CONFIG.BACK_LEFT);
        leftBack = hardwareMap.get(DcMotorEx.class, CONFIG.FRONT_LEFT);
        rightBack = hardwareMap.get(DcMotorEx.class, CONFIG.FRONT_RIGHT);
